...
export default function Login() {
  ...
  useEffect(() => {
    ...
    navigate(role === "artist" ? "/my-events" : "/my-bookings");
  ...
  return (
    <div className="flex min-h-[calc(100vh-130px)] items-center justify-center bg-gray-50 px-4">
      <div className="surface-card w-full max-w-md p-8">
        <h1 className="mb-1 text-2xl font-semibold text-gray-800">Welcome back</h1>
